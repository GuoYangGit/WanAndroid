package com.guoyang.module.wan.mvvm.model.repository

import com.guoyang.module.wan.mvvm.model.data.*
...
class Repo @Inject constructor(private val remote: ApiService) {
